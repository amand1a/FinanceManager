...
fun StartScreen( navToSignIn:()-> Unit , navToSignUp: ()-> Unit ,modifier: Modifier = Modifier){
    ...
    Box(modifier = modifier) {
        Image(painter = painterResource(id = R.drawable.welcome), contentDescription = "welcome" , contentScale = ContentScale.FillBounds)
        ...
        Column(modifier = Modifier.fillMaxSize() , horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Button(onClick = { navToSignUp() }, modifier = Modifier
                .fillMaxWidth(0.65f)
                .height(75.dp) ,
